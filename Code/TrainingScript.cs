...
public class TrainingScript : MonoBehaviour
{
    ...
    {
        Debug.Log("SONO IN DATASELECTOR");
        //  mano sinistra DISPOSITIVO 1
        ...
        //Debug.Log("SONO IN DATASELECTOR 2");
        //  mano destra DISPOSITIVO 1
